...
const navItems: { id: View; label: string; icon: React.ReactNode; badge?: number }[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
        <path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" strokeLinecap="round" strokeLinejoin="round" /><circle cx="12" cy="12" r="3" />
      </svg>
    ),
  },
];
    ...
    <aside className="w-64 bg-slate-900 flex flex-col h-screen sticky top-0 shrink-0">
      ...
      <div className="px-5 py-5 border-b border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-white font-bold text-base tracking-tight">AeroScribe</div>
            <div className="text-slate-400 text-xs">Research Engine v1.0</div>
          </div>
        </div>
      </div>
          ...
          >
            ...
            {item.badge && (
              <span className={`text-xs px-1.5 py-0.5 rounded-full font-semibold ${
                activeView === item.id ? 'bg-blue-500 text-white' : 'bg-orange-500 text-white'
              }`}>
                {item.badge}
              </span>
            )}
      ...
      <div className="px-4 py-4 border-t border-slate-800">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center text-white text-xs font-bold">KN</div>
          <div className="flex-1 min-w-0">
            <div className="text-white text-sm font-medium truncate">K. Narayana Reddy</div>
            <div className="text-slate-500 text-xs">Researcher</div>
          </div>
